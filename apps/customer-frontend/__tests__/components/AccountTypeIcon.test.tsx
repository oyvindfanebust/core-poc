...
describe('AccountTypeIcon', () => {
  ...
  describe('Visual Consistency', () => {
    ...
    it('should maintain consistent sizing across different account types', () => {
      const { container: depositContainer } = render(
        <AccountTypeIcon accountType="DEPOSIT" size="large" />,
      );
      const { container: loanContainer } = render(
        <AccountTypeIcon accountType="LOAN" size="large" />,
      );
