...
const DepositIcon = () => (
  <>
    <path
      ...
      fill="currentColor"
    />
    <path d="M7 12h2v5h6v-5h2l-5-5-5 5z" fill="currentColor" />
  </>
);
...
const LoanIcon = () => (
  <>
    <path
      ...
      fill="currentColor"
    />
    <path d="M17 12h-2V7H9v5H7l5 5 5-5z" fill="currentColor" />
  </>
);
...
const CreditIcon = () => (
  <>
    <path
      ...
      fill="currentColor"
    />
    <path d="M11 17h2v-4h-2v4zm0-6h2V9h-2v2z" fill="currentColor" />
  </>
);
...
const DefaultIcon = () => (
  <>
    <path
      ...
      fill="currentColor"
    />
    <path d="M11 17h2v-6h-2v6z" fill="currentColor" />
  </>
);
